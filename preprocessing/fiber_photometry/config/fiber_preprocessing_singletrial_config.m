%% ============================================================================
%  FIBER PREPROCESSING -- SINGLE-TRIAL RUN CONFIGURATION
%  ============================================================================
%  This is the ONE place to edit run parameters for the single-trial pipeline.
%  It is a script-include: run_fiber_preprocessing_singletrial.m loads it
...
%% ANALYSIS MODE
ANALYSIS_MODE = 'single_trial';  % 'single_trial' or 'multi_fov'
...
RECORDING_DATE = '01_01_25';                % Format: DD-MM-YY
...
GENERATE_MULTI_FIBER_PLOT = true;  % Generate combined multi-fiber visualization
...
%% TIME PERIOD CONFIGURATION (for single trial analysis)
PRE_STIM_PERIOD = [0, 10];        % [start, end] in seconds - baseline period
STIM_PERIOD = [10, 20];            % [start, end] in seconds - stimulation period
